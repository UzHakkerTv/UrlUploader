...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Iltimos Kanalimizga Obuna Bo'ling: @Bot_Owners"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "{} Soniya ichida yuklab olindi.📥\n{} Soniya ichida yuklandi.📤¤\n📡Kanalimiz : @InfoTeleUz, @Bot_Owners"
    ...
    SAVED_CUSTOM_THUMB_NAIL = "Shaxsiy video /file eskizi saqlandi. Ushbu rasm video /file ishlatiladi."
    ...
    NO_VOID_FORMAT_FOUND = "XATOLIK ... \ n <b> YouTubeDL </b> Ma'lumot: {}"
    USER_ADDED_TO_DB = "<a href='tg://user?id={}'> {} </a> foydalanuvchisi {} ga {} qadar qo'shildi."
    CURENT_PLAN_DETAILS = """Siz Haqingizda
--------
Telegram ID: <code>{}</code>
Plan: Bepul
Muddati tugaydi: 31/12/2021"""
    HELP_USER = """Salom, Men URL manzilni yuklash botiman ..
...
📡Kanallarimiz @InfoTeleUz , @Bot_Owners"""
    ...
    EXTRACT_ZIP_INTRO_THREE = "Qabul qilingan faylni tahlil qilish. вљ пёЏ Bu biroz vaqt talab qilishi mumkin. Iltimos, sabr qiling."
